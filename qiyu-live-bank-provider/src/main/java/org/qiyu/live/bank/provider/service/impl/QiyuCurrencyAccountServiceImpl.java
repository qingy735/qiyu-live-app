...
import org.qiyu.live.bank.interfaces.constants.TradeTypeEnum;
...
public class QiyuCurrencyAccountServiceImpl implements IQiyuCurrencyAccountService {
    ...
    private static ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(2, 4, 30, TimeUnit.SECONDS,
    ...
    @Override
    public AccountTradeRespDTO consume(AccountTradeReqDTO reqDTO) {
        // long userId = reqDTO.getUserId();
        // int num = reqDTO.getNum();
        // // 判断账户余额是否充足 考虑无记录情况
